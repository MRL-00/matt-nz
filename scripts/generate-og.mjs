...
<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <!-- description -->
  <text x="64" y="430" fill="${dim}" font-family="JetBrains Mono, ui-monospace, monospace" font-size="26">notes on backends, mobile, and the bits between teams.</text>
  ...
  <text x="${W / 2}" y="580" fill="${muted}" font-family="JetBrains Mono, ui-monospace, monospace" font-size="22" text-anchor="middle">christchurch · nz</text>
  <text x="${W - 64}" y="580" fill="${accent}" font-family="JetBrains Mono, ui-monospace, monospace" font-size="22" text-anchor="end">● open to work</text>
</svg>`;
